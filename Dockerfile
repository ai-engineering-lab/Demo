...
#> curl -X POST http://localhost:11434/api/generate -d '{  "model": "deepseek-r1",  "prompt":"What is water?"}'

## Use Sky-T1-32B to verify: http://164.152.23.196:3000/
